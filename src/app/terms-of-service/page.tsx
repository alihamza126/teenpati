            ...
            <section className="py-12 px-6">
                <div className="max-w-4xl mx-auto prose prose-lg">
                    ...
                    <ul className="text-gray-700 space-y-2 mb-4">
                        <li>• Gaming app reviews and comparisons</li>
                        <li>• Information about bonuses and promotions</li>
                        <li>• Download links and app recommendations</li>
                        <li>• Educational content about gaming apps</li>
                    ...
                    <ul className="text-gray-700 space-y-2 mb-4">
                        ...
                        <li>• Be responsible for your own gaming activities and decisions</li>
                    </ul>

                    <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">Prohibited Activities</h2>
                    <div className="bg-red-50 border-l-4 border-red-400 p-6 mb-6">
                        <h3 className="text-lg font-bold text-red-800 mb-2">🚫 You May Not:</h3>
                    ...
                    <ul className="text-gray-700 space-y-2 mb-4">
                        ...
                        <li>• You may not use our trademarks or logos without written consent</li>
                    ...
                    <ul className="text-gray-700 space-y-2 mb-4">
                        ...
                        <li>• Warranties regarding the security of the website</li>
                    </ul>
                    ...
                    <ul className="text-gray-700 space-y-2 mb-4">
                        ...
                        <li>• Any loss or damage resulting from your use of recommended apps</li>
                    </ul>
                    ...
                    <div className="bg-orange-50 border-l-4 border-orange-400 p-6 mb-6">
                        <h3 className="text-lg font-bold text-orange-800 mb-2">🎮 Gaming Disclaimer</h3>
                        <ul className="text-orange-700 space-y-1">
                            <li>• Online gaming laws vary by jurisdiction</li>
                            <li>• You are responsible for compliance with local laws</li>
                            <li>• We do not guarantee the legality of any gaming app</li>
                            <li>• Please verify local regulations before gaming</li>
                            <li>• Gaming should be for entertainment purposes only</li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg">
                        <ul className="text-gray-700 space-y-2">
                            <li>• Email: legal@rummynabobapk.com</li>
